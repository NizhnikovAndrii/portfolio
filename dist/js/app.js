(() => {
    ...
    (() => {
        ...
        document.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".checkbox") && targetElement.closest(".filter__block")) filterBlock(targetElement);
            if (targetElement.closest(".filter__button")) {
                const clearButton = targetElement.closest(".filter__button");
                filterBlockClear(clearButton);
            }
        }));
        function filterBlock(targetElement) {
            const filterBlock = targetElement.closest(".filter__block");
            const filterClear = filterBlock.querySelector(".filter__button");
            setTimeout((() => {
